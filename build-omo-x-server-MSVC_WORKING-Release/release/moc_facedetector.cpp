...
#include "../../omo-x-server/facedetector.h"
...
QT_MOC_LITERAL(1, 13, 19), // "requestStatusUpdate"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 3), // "str"
QT_MOC_LITERAL(4, 38, 9), // "faceFound"
QT_MOC_LITERAL(5, 48, 8), // "faceData"
QT_MOC_LITERAL(6, 57, 25), // "onDownsampleFactorChanged"
QT_MOC_LITERAL(7, 83, 6) // "factor"

    },
    "FaceDetector\0requestStatusUpdate\0\0str\0"
    "faceFound\0faceData\0onDownsampleFactorChanged\0"
    "factor"
};
...
void FaceDetector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestStatusUpdate((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->faceFound((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->onDownsampleFactorChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (FaceDetector::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FaceDetector::requestStatusUpdate)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FaceDetector::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FaceDetector::faceFound)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FaceDetector::requestStatusUpdate(QString _t1)
{
...
// SIGNAL 1
void FaceDetector::faceFound(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
