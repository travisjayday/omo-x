...
#include "../../omo-x-server/workerthread.h"
...
QT_MOC_LITERAL(3, 25, 4) // "_img"

    },
    "WorkerThread\0imageReady\0\0_img"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::imageReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::imageReady(QImage _t1)
{
